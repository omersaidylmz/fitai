...
def analyze_seated_dumbell(keypoints):
    ...
    if 55 <= avg_angle <= 65:
        ...
        feedback = "Starting position - Ready to perform Machine Shoulder Press exercises"
        is_correct = True
    
    # 30-45 derece - mükemmel curl pozisyonu
    elif 150 <= avg_angle <= 160:
        movement_state = "perfect_seated_dumbell"
        feedback = "Perfect Machine Shoulder Press position! Great!"
        is_correct = True
